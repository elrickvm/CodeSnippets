...
def isValidWord(word, hand, wordList):
    ...
    for letter in letterCount.keys():
        if letterCount[letter] > hand.get(letter, 0):
            return False
    return True
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    """
    totalScore = 0
    orgHandLength = calculateHandlen(hand)
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                points = getWordScore(userInput, orgHandLength)
                totalScore += points
                print ('"' + str(userInput) +'"'+ " earned " + str(points) + " points" + "." + " Total: " + str(totalScore))
                print
